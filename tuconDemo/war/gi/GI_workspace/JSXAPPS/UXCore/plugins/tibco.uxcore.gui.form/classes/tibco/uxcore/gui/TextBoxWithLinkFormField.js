...
jsx3.lang.Class.defineClass("tibco.uxcore.gui.TextBoxWithLinkFormField", tibco.uxcore.gui.FormField, null,
    function(FORMFIELD, formfield) {
        ...
        formfield.setLinkText = function(sText, bRepaint) {
            this.setProperty("linktext", sText);
            if(bRepaint) {
                this.repaint();
            }
            return this;
        ...
        formfield.getLinkText = function() {
        ...
        formfield.getFieldTemplate = function() {
            return '<var name="linkcursor">this._isEnabled() ? \'pointer\' : \'default\'</var><div u:protected="true" u:id="textlabel" style="display: {viewFieldDisplay}; margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; position: relative; width: {formfieldwidth}; left: 0px; top: 1px; font-family: Arial; font-size: 11px; font-weight: normal; color: {color}; overflow-x: hidden;"><span u:protected="true" style="height: 18px; width: 75%; float:left;"><text>{fieldValueEscaped|}</text></span><span u:protected="true" style="text-decoration:underline; color: #257792; width: 25%; float:right; cursor: {linkcursor}" onmousedown="{onlinkclick}"><span style="padding: 0px 5px 0px 5px;"><text>{linktext|Choose}</text></span></span></div><div u:id="editField" style="display: {editFieldDisplay}; margin: 5px 0px 0px 0px; padding: 0px 0px 0px 0px; position: relative; width: 100%; height: 18px; left: 0px; top: 0px; font-family: Arial; font-size: 11px; font-weight: normal;"><input u:protected="true" u:id="textfield" style="border: {bordercolor}; margin: 0px 0px 0px 0px; padding: 1px 5px 0px 5px; position: relative; width: 75%; height: 18px; left: 0px; top: 0px; font-family: Arial; font-size: 11px; font-weight: normal; background-color: {fieldcolor}; color: {fieldtextcolor}; float:left;" value="{fieldvalue2|}" onfocus="{onifocus}" onblur="{oniblur}" onmousedown="{onimousedown}" onkeydown="{onikeydown}" onkeyup="{onKeyUp}" onkeypress="{onKeyPressed}"/><span style="padding: 0px 5px 0px 5px; text-decoration:underline; color: #257792; width: 25%; height: 100%; float:left; cursor: {linkcursor}" onmousedown="{onlinkclick}"><text>{linktext|Choose}</text></span></div>';
        }

        formfield.onlinkclick = function() {
            if(this._isEnabled()) {
//            jsx3.log("Link clicked");
            try {
            var ret = this.doEvent("jsxlinkclicked", {});
            } catch(ex) {
