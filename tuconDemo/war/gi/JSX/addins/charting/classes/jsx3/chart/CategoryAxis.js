...
ub={a:"aligned",b:"between",c:"SB",d:"Nr",e:"tickAlignment",f:"gn"};c.TICKS_ALIGNED=ub.a;c.TICKS_BETWEEN=ub.b;c.MAX_TICKS=200;c.BG={aligned:1,between:1};p.init=function(i,r,q){this.jsxsuper(i,r,q);this.tickAlignment=ub.b;this.categoryField=null;this.paddingLow=null;this.paddingHigh=null;this.qf(ub.c,0);this.qf(ub.d,0);};p.getTickAlignment=function(){return this.tickAlignment;};p.setTickAlignment=function(l){if(c.BG[l]){this.tickAlignment=l;}else throw new
...
da=this.getChart();if(da==null){this.qf(ub.c,0);this.qf(ub.d,0);}else{var
tb=da.Xh(this,true);var
ib=da.bh();this.qf(ub.d,tb.length);this.qf(ub.c,ib!=null?ib.length:0);}};p.Hf=function(){var
nb=this.nj(ub.f);if(nb!=null)return nb;var
B=this.nj(ub.c);nb=[];if(B<1)return nb;var
...
C=ga*pb;for(var
Qa=0;Qa<x&&Qa<c.MAX_TICKS;Qa++)nb.push(Math.round(C+Qa*pb));this.qf(ub.f,nb);return nb;};p.bi=function(){var
B=this.nj(ub.c);if(this.tickAlignment==ub.b){var
Ab=this.Hf();var
Xa=[];for(var
