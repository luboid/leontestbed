...
ka=null;if(this.type==ub.c)ka=this.Oi(na,ub.e);var
...
bb=0;bb<la;bb++){var
La=na[bb];La._k();for(var
ca=0;ca<Ua.length;ca++){var
Ja=Ua[ca];var
fa=null,X=null;if(jsx3.chart.isValueAxis(u)){var
Eb=La.yd(Ja);if(this.type==ub.a){fa=La.getMinValue(Ja);if(fa==null)fa=0;X=Eb;if(X==null)continue;}else if(this.type==ub.b||this.type==ub.c){var
...
mb=La.Sc();I=za-Math.ceil(mb/2);Qa=za+Math.floor(mb/2);}else if(jsx3.chart.isCategoryAxis(kb)){var
Aa=kb.getRangeForCategory(ca);var
wa=this.PI(Aa[0],Aa[1],bb,la,U,K);I=wa[0];Qa=wa[1];}La.Nm(Ja,ca,jb,I,Ha,Qa);}La.updateView();rb.appendChild(La.getCanvas());}};d.getVersion=function(){return jsx3.chart.si;};});jsx3.Class.defineClass("jsx3.chart.BarChart",jsx3.chart.BCChart,null,function(e,n){n.init=function(l,p,s,d,a){this.jsxsuper(l,p,s,d,a);};n.tc=function(h){return h instanceof jsx3.chart.BarSeries;};n.getXRange=function(o){return this.oX(o);};n.getYRange=function(i){return this.yN(i);};n.RE=function(){return this.getPrimaryXAxis();};n.tY=function(){return this.getPrimaryYAxis();};});jsx3.Class.defineClass("jsx3.chart.ColumnChart",jsx3.chart.BCChart,null,function(d,a){a.init=function(c,g,j,m,k){this.jsxsuper(c,g,j,m,k);};a.tc=function(q){return q instanceof jsx3.chart.ColumnSeries;};a.getXRange=function(j){return this.yN(j);};a.getYRange=function(c){return this.oX(c);};a.RE=function(){return this.getPrimaryYAxis();};a.tY=function(){return this.getPrimaryXAxis();};});
