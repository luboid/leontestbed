...
Ba=null,Ra=null;if(this.minExponent!=null){Ba=this.minExponent;}else if(this.baseAtZero)Ba=0;if(this.maxExponent!=null)Ra=this.maxExponent;O=O*b.WM;da=da*b.WM;if(Ba==null)if(O==0)Ba=0;else Ba=Math.floor(Math.log(O)/Math.log(this.base));if(Ra==null)Ra=Math.ceil(Math.log(da)/Math.log(this.base));this.qf(ub.a,Ba);this.qf(ub.b,Ra);return true;};m.Xj=function(f){var
x=this.nj(ub.a);var
...
Pa=Va+Ra*(db-Va)/this.majorDivisions;sa.push(this.getCoordinateFor(Pa));Ga++;}}sa.push(this.getCoordinateFor(db));Ga++;}return sa;};m.hc=function(j,f){var
