...
xa=null;if(this.type==ub.c)xa=this.Oi(x,ub.e);var
...
Ma=Ib.getXValue(ja);if(Ma!=null)jb=tb.getCoordinateForNoClip(Ma);}else if(jsx3.chart.isCategoryAxis(tb))jb=tb.getPointForCategory(bb);if(jb!=null&&cb!=null)Ib.nd(ja,jb,cb,bb);else Ib.Ac(ja,jb,cb,bb);}Ib.updateView();T.appendChild(Ib.getCanvas());}};n.pd=function(){return this.type==ub.b||this.type==ub.c;};n.tc=function(p){return p instanceof jsx3.chart.LineSeries;};e.getVersion=function(){return jsx3.chart.si;};});
