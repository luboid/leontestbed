...
H=this.nj(ub.d);if(H==null){H=[];this.qf(ub.d,H);}H.push([m,e,d,l,c,q,r,f]);};h.xm=function(){this.xk(null);};h.jj=function(){var
T=this.nj(ub.d);if(T!=null)T.splice(0,T.length);};h.updateView=function(){this.jsxsuper();var
ob=this.getCanvas();var
hb=ob.getWidth();var
Ya=ob.getHeight();var
ba=this.nj(ub.d);if(ba==null)return;var
...
U=ba[Y][7];var
tb=new
G.Shape(null,0,0,hb,Ya);tb.setId(this.getId()+ub.e+Y);ob.appendChild(tb);tb.setFill(this.hd(ha,Y));tb.setStroke(this.Ys(Y));this.th(tb,Y,ha.getAttribute(ub.f));var
