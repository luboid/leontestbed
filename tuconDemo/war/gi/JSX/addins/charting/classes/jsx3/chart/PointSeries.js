...
ub={a:"jsx3.chart.PointRenderer.CIRCLE",b:"sj",c:"vo",d:"qe",e:"diameter",f:"area",g:"_p",h:"jsxid",i:"renderer"};m.Rp=25;g.init=function(c,j){this.jsxsuper(c,j);this.xField=null;this.yField=null;this.magnitude=null;this.renderer=ub.a;};g.lP=function(){var
Ya=this.nj(ub.b);if(Ya==null){Ya=[];this.qf(ub.b,Ya);}return Ya;};g.updateView=function(){this.jsxsuper();var
Lb=this.bo();var
Da=this.ql(Lb);this.qf(ub.c,Lb);this.qf(ub.d,Da);var
V=this.lP();for(var
...
ub={a:"jsx3.chart.PointSeries.tooltip",b:"{",c:",",d:"}"};s.DEFAULT_MAGNITUDE=4;k.init=function(e,h){this.jsxsuper(e,h);this.magnitude=null;this.setTooltipFunction(ub.a);};k.nd=function(o,f,m,l){(this.lP()).push([o,f,m,l]);};k.DE=function(g){this.jD(g[0],g[1],g[2],g[3],this.getMagnitude());};k.getMagnitude=function(){return this.magnitude!=null?this.magnitude:s.DEFAULT_MAGNITUDE;};k.setMagnitude=function(b){this.magnitude=b;};s.tooltip=function(g,f){var
...
ub={a:"jsx3.chart.BubbleSeries.tooltip",b:"{",c:",",d:"}"};k.init=function(h,e){this.jsxsuper(h,e);this.magnitudeField=null;this.setTooltipFunction(ub.a);};k.nd=function(i,s,f,r,m){(this.lP()).push([i,s,f,r,m]);};k.DE=function(e){this.jD(e[0],e[1],e[2],e[3],e[4]);};c.tooltip=function(b,e){var
L=b.getXValue(e);var
C=b.getYValue(e);var
