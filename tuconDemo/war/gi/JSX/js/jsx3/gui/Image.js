...
Na=this.getWidth()!=null?ub.a+V.Nd()+ub.b:ub.c;var
F=this.getHeight()!=null?ub.d+V.Qi()+ub.b:ub.c;return this.jsxsuper(ub.e+jsx3.html.pe+ub.f+Db+ub.b+Na+F+ub.g);};h.onSetChild=function(p){return false;};h.Rc=function(p,m,b){this.ag(p,m,b,1);};h.getRenderedWidth=function(){var
