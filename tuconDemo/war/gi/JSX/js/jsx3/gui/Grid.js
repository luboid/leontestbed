...
Bb=Wa.ownerDocument.getElementById(this._jsxrowid);if(Bb!=null)return this._jsxrowid.substring((this.getId()).length+1);}this.uL();}return null;};o.getActiveMask=function(){return this._jsxcurmask;};o.getActiveCell=function(){return this._jsxFh;};o.getActiveRow=function(){var
...
K=typeof p.getMaskValue==ub.C?p.getMaskValue():p.getValue();if(K==null)K=ub.q;this.insertRecordProperty(f,g,K,true);}};o._ebKeyDown=function(a,d){if(this.jsxsupermix(a,d))return;if(this._jsxFh==null||this._jsxFh.parentNode==null)return;var
Cb=this._jsxFh;var
