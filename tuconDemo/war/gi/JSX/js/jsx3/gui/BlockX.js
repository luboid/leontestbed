...
ub={a:"loading",b:"error",c:"xml.err_load_xsl",d:"jsx3.gui.BlockX.",e:"jsxdisableescape",f:"xE",g:"3.00.00"};g.init=function(n,k,f,l,i){this.jsxsuper(n,k,f,l,i);};g.paint=function(){this.applyDynamicProperties();if(this.jsxxslasync){var
Ta=this.getXSL();if(!Ta.hasError()&&Ta.getNamespaceURI()==jsx3.app.Cache.XSDNS){var
Da=Ta.getNodeName();if(Da==ub.a)this.TL(true);else if(Da==ub.b)(jsx3.util.Logger.getLogger(a.jsxclass.getName())).error(jsx3._msg(ub.c,this,Ta.getAttribute(ub.b)));return this.jsxsuper(this._getLocaleProp(ub.d+Ta.getNodeName()));}}return this.jsxsuper(this.doTransform());};g.onAfterPaint=function(n){var
Ia=jsx3.xml.Template;if(!Ia.supports(1)&&(this.getXSLParams())[ub.e])jsx3.html.removeOutputEscaping(n);};g.getXSLString=function(){return this.jsxxsl;};g.setXSLString=function(r){this.jsxxsl=r;return this;};g.getXSLURL=function(){return this.jsxxslurl;};g.setXSLURL=function(e){this.jsxxslurl=e;return this;};g.getXslAsync=function(){return this.jsxxslasync;};g.setXslAsync=function(n){this.jsxxslasync=jsx3.Boolean.valueOf(n);return this;};g.onXmlBinding=function(k){this.jsxsupermix(k);this.repaint();};g.TL=function(m){if(Boolean(this._jsxxslbound)!=m){var
C=this.getServer();if(C){var
A=C.getCache();var
v=this.getXSLId();if(m)A.subscribe(v,this,ub.f);else A.unsubscribe(v,this);this._jsxxslbound=m;}}};g.xE=function(s){this.TL(false);this.repaint();};g.getXSL=function(){var
