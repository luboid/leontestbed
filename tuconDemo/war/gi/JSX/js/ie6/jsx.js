...
E=r.getRelativePosition(null,h);y=y-E.L;Oa=Oa-E.T;}else{Oa=Oa-e.ownerDocument.body.scrollTop;y=y-e.ownerDocument.body.scrollLeft;}}return {L:y,T:Oa,W:e.offsetWidth,H:e.offsetHeight};}};r.copy=function(f){window.clipboardData.setData(ub.F,f);};r.paste=function(){return window.clipboardData.getData(ub.F);};r.mF=jsx3.resolveURI(ub.G);r.wZ=jsx3.resolveURI(ub.H);r.getCSSFade=function(j){return r.getCSSPNG(j?r.mF:r.wZ);};r.getCSSPNG=function(m){return ub.I+m+ub.J;};r.getJSXParent=function(j,e){while(j!=null){if(j.id&&j.id.indexOf(ub.K)==0){var
zb=e?e.getJSXById(j.id):jsx3.GO(j.id);if(zb!=null)return zb;}if(!j.parentNode){var
Ia=j.parentWindow||j.defaultView;j=Ia?Ia.frameElement:null;}else j=j.parentNode;}return null;};r.removeOutputEscaping=function(n){var
Ea=n?[n]:[];while(Ea.length>0){var
D=Ea.shift();if(D.nodeName&&r._tn(D)==ub.m&&D.className==ub.L){D.innerHTML=((((D.innerHTML.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.n1);D.removeAttribute(ub.V);}else if(D.childNodes)Ea.push.apply(Ea,this.nodesToArray(D.childNodes));}};r.removeOutputEscapingSpan=function(o){return o.replace(ub.W,function(f,e){return ((((e.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.n1);});};r.ju={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.n1=function(l,a){var
eb=r.ju[a];return eb?ub.X+eb+ub.Y:l;};r.FI=ub.Z;r.loadImages=function(a){var
I=document.getElementById(r.FI);if(I==null){var
Wa=(document.getElementsByTagName(ub.c))[0];if(Wa){I=document.createElement(ub.n);I.id=r.FI;I.style.display=ub._;Wa.insertBefore(I,Wa.firstChild);}else return;}var
cb=jsx3.$A.is(a)?a:arguments;for(var
T=0;T<cb.length;T++){if(!cb[T])continue;var
J=jsx3.resolveURI(cb[T]);var
Ib=r.FI+ub.aa+J;if(document.getElementById(Ib)==null){var
H=document.createElement(ub.ba);H.setAttribute(ub.ca,Ib);H.setAttribute(ub.da,J);I.appendChild(H);}}};r.updateRule=function(h,d,a){var
Ka=jsx3.html.getRuleByName(h);if(Ka)Ka.style[d]=a;};r.getElementById=function(d,p,k){return this.findElements(d,function(f){return f.id==p;},k,false,false,true);};r.getElementByTagName=function(k,i,s){i=i.toLowerCase();return this.findElements(k,function(a){return r._tn(a)==i;},s,false,false,true);};r.getElementsByTagName=function(n,l,b){l=l.toLowerCase();return this.findElements(n,function(q){return r._tn(q)==l;},b,true,false,true);};r.findElements=function(h,d,o,j,c,a){var
S=o?ub.ea:ub.fa;var
sb=j?[]:null;var
E=a?[h]:this.nodesToArray(h.childNodes);while(E.length>0){var
R=E.shift();if(d.call(null,R))if(j)sb[sb.length]=R;else return R;if(!c)E[S].apply(E,this.nodesToArray(R.childNodes));}return sb;};r.getElmUpByTagName=function(i,q,b){return r.findElementUp(i,function(s){return r._tn(s)==q;},b);};r.findElementUp=function(g,n,s){var
ma=g.ownerDocument.documentElement;var
fa=s?g:g.parentNode;while(fa!=null){if(n.call(null,fa))return fa;if(fa==ma)break;fa=fa.parentNode;}return null;};r.selectSingleElm=function(k,p){var
R=1,fb=arguments;if(arguments.length==2)if(typeof p==ub.i){R=0;fb=p.split(ub.ga);}else if(jsx3.$A.is(p)){R=0;fb=p;}var
Ga=k;for(var
K=R;Ga!=null&&K<fb.length;K++){var
lb=fb[K];if(!isNaN(lb)){var
Da=Number(lb);var
I=Ga.childNodes.length;var
Ta=0,da=0;for(;Ta<I&&da<Da;Ta++)if(Ga.childNodes[Ta].nodeType==1)da++;Ga=Ga.childNodes[Ta];}else throw new
jsx3.Exception();}return Ga;};r.nodesToArray=function(m){var
N=new
Array(m.length);for(var
zb=0;zb<m.length;zb++)N[zb]=m[zb];return N;};r.getSelection=function(k){return new
r.Selection(k);};r.focusNext=function(g,f){var
sb=g;while(sb.lastChild)sb=sb.lastChild;while(!r.isFocusable(sb)&&sb!=g)sb=sb.previousSibling||sb.parentNode;if(sb!=g||r.isFocusable(sb))if(sb.onfocus!=null){var
sa=sb.onfocus;sb.onfocus=null;sb.focus();jsx3.sleep(function(){sb.onfocus=sa;});}else sb.focus();};r.focusPrevious=function(l,a){var
Z=this.findElements(l,function(q){return r.isFocusable(q);},true,false,false,true);if(Z!=null)if(Z.onfocus!=null){var
Na=Z.onfocus;Z.onfocus=null;Z.focus();jsx3.sleep(function(){Z.onfocus=Na;});}else Z.focus();};r.focus=function(i){try{if(i.focus)i.focus();}catch(Kb){}};r.addClass=function(f,j){var
ob=f.className;if(ob){if(!(jsx3.$A(ob.split(ub.ha))).contains(j))f.className=ob+ub.ia+j;}else f.className=j;};r.removeClass=function(d,h){var
ib=d.className;if(ib&&ib.indexOf(h)>=0){var
V=jsx3.$A(ib.split(ub.ha));if(V.remove(h))d.className=V.join(ub.ia);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(s,m){var
ub={a:"textarea",b:"EndToEnd",c:/\r\n|\r|\n/g,d:"character",e:"end"};m.init=function(p){this.M6=(p.ownerDocument.selection.createRange()).duplicate();this.BY=p;};m.getStartIndex=function(){var
zb=this.BY.ownerDocument.selection.createRange();var
ua=null;if(html._tn(this.BY)==ub.a){ua=zb.duplicate();ua.moveToElementText(this.BY);}else ua=this.BY.createTextRange();ua.setEndPoint(ub.b,zb);return ua.text.length-zb.text.length;};m.getEndIndex=function(){var
Da=this.BY.ownerDocument.selection.createRange();var
Ia=null;if(html._tn(this.BY)==ub.a){Ia=Da.duplicate();Ia.moveToElementText(this.BY);}else Ia=this.BY.createTextRange();Ia.setEndPoint(ub.b,Da);return Ia.text.length;};m.setRange=function(p,d){var
sa=this.BY.value;var
Ea=ub.c;Ea.lastIndex=0;var
_=d;while(Ea.test(sa)&&Ea.lastIndex<=_){p=p-1;d=d-1;}var
G=this.BY.createTextRange();G.collapse(true);G.moveStart(ub.d,p);G.moveEnd(ub.d,d-p);G.select();};m.getOffsetLeft=function(){return this.M6.offsetLeft;};m.getOffsetTop=function(){return this.M6.offsetTop;};m.getText=function(){return this.M6.text;};m.setText=function(c){this.M6.text=c;};m.insertCaret=function(l){if(l==ub.e){this.M6.collapse();this.M6.select();}else throw new
