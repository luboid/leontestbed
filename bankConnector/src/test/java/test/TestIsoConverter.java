...
public class TestIsoConverter extends TestCase {
	...
	public void testIsoToXml() throws Exception {
		...
		InputStream mapFile = Iso8583ToXml.class.getResourceAsStream("/com/topfinance/plugin/cnaps2/ibps.101.001.01.xml.map");
	...
	public void atestXmlToIso() throws Exception {
		System.out.println("start");
