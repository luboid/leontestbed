...
import org.jpos.iso.IFMC_LLBINARY;
...
public class ISOIBPSPackager extends ISOBasePackager {
 ...
 /*PP046*/ new IF_CHAR(8,"T+1��������"),
  ...
  /*PP066*/ new IF_CHAR(4,"ҵ�����ͱ���"),
    ...
    /*079*/ new IFA_LLLCHAR (  1, ""),
    /*080*/ new IFA_LLLCHAR (  1, ""),
    /*081*/ new IFA_LLLCHAR (  1, ""),
    /*082*/ new IFA_LLLCHAR (  1, ""),
    /*083*/ new IFA_LLLCHAR (  1, ""),
    /*084*/ new IFA_LLLCHAR (  1, ""),
    /*085*/ new IFA_LLLCHAR (  1, ""),
    /*086*/ new IFA_LLLCHAR (  1, ""),
    /*087*/ new IFA_LLLCHAR (  1, ""),
    /*088*/ new IFA_LLLCHAR (  1, ""),
    /*089*/ new IFA_LLLCHAR (  1, ""),
    /*090*/ new IFA_LLLCHAR (  1, ""),
    /*091*/ new IFA_LLLCHAR (  1, ""),
    /*092*/ new IFA_LLLCHAR (  1, ""),
    /*093*/ new IFA_LLLCHAR (  1, ""),
    /*094*/ new IFA_LLLCHAR (  1, ""),
    /*095*/ new IFA_LLLCHAR (  1, ""),
    ...
    /*103*/ new IFA_LLLCHAR (  1, ""),
    /*104*/ new IFA_LLLCHAR (  1, ""),
    /*105*/ new IFA_LLLCHAR (  1, ""), 
    /*106*/ new IFA_LLLCHAR (  1, ""), 
    /*107*/ new IFA_LLLCHAR (  1, ""),
    /*108*/ new IFA_LLLCHAR (  1, ""),
    /*109*/ new IFA_LLLCHAR (  1, ""),
    /*110*/ new IFA_LLLCHAR (  1, ""),
    /*111*/ new IFA_LLLCHAR (  1, ""), 
    /*112*/ new IFA_LLLCHAR (  1, ""),
    /*113*/ new IFA_LLLCHAR (  1, ""),
    /*114*/ new IFA_LLLCHAR (  1, ""),
    /*115*/ new IFA_LLLCHAR (  1, ""),
    /*116*/ new IFA_LLLCHAR (  1, ""),
