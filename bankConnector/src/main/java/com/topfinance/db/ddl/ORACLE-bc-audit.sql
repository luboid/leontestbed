...
CREATE INDEX BC_AUDIT_AUDITID ON TBL_AUDIT(AUDIT_ID);
...
CREATE INDEX BC_AUDITDETAIL_UID ON TBL_AUDIT_DETAIL(U_ID);
...
CREATE INDEX TBL_RESEND_RESENDKEY ON TBL_RESEND(RESENDKEY)
--: