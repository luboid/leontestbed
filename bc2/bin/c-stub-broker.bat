...
set JVM_ARGS=-Dlog4j.configuration=file:%INSTALL_HOME%/bin/log4j/log4j-c.properties

set JVM_EXT_ARGS=
rem set JVM_EXT_ARGS=-Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=8000
