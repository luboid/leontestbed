...
rem 601
rem call %JAXB_HOME%\bin\xjc -b D:\bankConnector\source\test\jaxb\camt.054.001.02.jxb -d D:\bankConnector\SVN-ROOT\gwXML\src D:\bankConnector\source\sample\Schema\camt.054.001.02.xsd

rem 604
call %JAXB_HOME%\bin\xjc -b D:\bankConnector\source\test\jaxb\saps.604.001.01.jxb -d D:\bankConnector\SVN-ROOT\gwXML\src D:\bankConnector\source\sample\Schema\saps.604.001.01.xsd
