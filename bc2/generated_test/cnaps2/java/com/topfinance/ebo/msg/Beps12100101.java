...
@Entity
@Table(name = "T_MSG_BEPS_121_001_01__")
public class Beps12100101  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="cstmrCdtTrf.cstmrCdtTrfInf[0].cstmrCdtTrfAddtlInf.colltnInf")
    private java.util.Set<Beps12100101ColltnInf> colltnInf;
    
    @JaxbMapping(objPath="cstmrCdtTrf.cstmrCdtTrfInf[0].cstmrCdtTrfAddtlInf.colltnWthAccptncInf")
    private java.util.Set<Beps12100101ColltnWthAccptncInf> colltnWthAccptncInf;
    
    @JaxbMapping(objPath="cstmrCdtTrf.cstmrCdtTrfInf[0].cstmrCdtTrfAddtlInf.ntlTrsrInf")
    private java.util.Set<Beps12100101NtlTrsrInf> ntlTrsrInf;
    
    @JaxbMapping(objPath="cstmrCdtTrf.cstmrCdtTrfInf[0].cstmrCdtTrfAddtlInf.pmtInf")
    private java.util.Set<Beps12100101PmtInf> pmtInf;
   ...
   *
   * @param newCstmrCdtTrfInf the new cstmrCdtTrfInf
   */

    public void  setCstmrCdtTrfInf(java.util.Set<Beps12100101CstmrCdtTrfInf> newCstmrCdtTrfInf) {
        cstmrCdtTrfInf = newCstmrCdtTrfInf;
    }	  
  /**
   * Returns the colltnInf
   * 
   * @return the colltnInf
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps12100101ColltnInf> getColltnInf() {
        return colltnInf;
    }	 
   ...
   * Sets the colltnInf
   *
   * @param newColltnInf the new colltnInf
   */

    public void  setColltnInf(java.util.Set<Beps12100101ColltnInf> newColltnInf) {
        colltnInf = newColltnInf;
    }	  
  /**
   * Returns the colltnWthAccptncInf
   * 
   * @return the colltnWthAccptncInf
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps12100101ColltnWthAccptncInf> getColltnWthAccptncInf() {
        return colltnWthAccptncInf;
    }	 
     
  /**
   * Sets the colltnWthAccptncInf
   *
   * @param newColltnWthAccptncInf the new colltnWthAccptncInf
   */

    public void  setColltnWthAccptncInf(java.util.Set<Beps12100101ColltnWthAccptncInf> newColltnWthAccptncInf) {
        colltnWthAccptncInf = newColltnWthAccptncInf;
    }	  
  /**
   ...
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps12100101NtlTrsrInf> getNtlTrsrInf() {
        return ntlTrsrInf;
    }	 
   ...
   */
    ...
    public void  setNtlTrsrInf(java.util.Set<Beps12100101NtlTrsrInf> newNtlTrsrInf) {
   ...
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps12100101PmtInf> getPmtInf() {
        return pmtInf;
    }	 
   ...
   */
    ...
    public void  setPmtInf(java.util.Set<Beps12100101PmtInf> newPmtInf) {
        pmtInf = newPmtInf;
    }	  
