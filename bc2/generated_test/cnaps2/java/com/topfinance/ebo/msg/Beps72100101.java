...
/**
 * Beps72100101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_MSG_BEPS_721_001_01__")
public class Beps72100101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="ttlChck.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="ttlChck.prttn.ttlNb")
    private String ttlNb;
    
    @JaxbMapping(objPath="ttlChck.prttn.startNb")
    private String startNb;
    
    @JaxbMapping(objPath="ttlChck.prttn.startNb")
    private String endNb;
    
    @JaxbMapping(objPath="ttlChck.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="ttlChck.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="ttlChck.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="ttlChck.ttlChckInf.chckDt")
    private Date chckngDt;
    
    @JaxbMapping(objPath="ttlChck.ttlChckInf.chckPmtInf.nbOfChckInf")
    private String nbOfChckInf;
    
    @JaxbMapping(objPath="ttlChck.ttlChckInf.chckPmtInf.chckPmtInfDtls[0]")
    private java.util.Set<Beps72100101ChckPmtInfDtls> chckPmtInfDtls;
    
    @JaxbMapping(objPath="ttlChck.ttlChckInf.chckMsg")
    private java.util.Set<Beps72100101ChckMsgDtls> chckMsgDtls;
  ...
  /**
   * Returns the nbOfChckInf
   * 
   * @return the nbOfChckInf
   */
    @Column(name = "NBOFCHCKINF")
    public String getNbOfChckInf() {
        return nbOfChckInf;
    }	 
     
  /**
   * Sets the nbOfChckInf
   *
   * @param newNbOfChckInf the new nbOfChckInf
   */

    public void  setNbOfChckInf(String newNbOfChckInf) {
        nbOfChckInf = newNbOfChckInf;
    }	  
  /**
   * Returns the chckPmtInfDtls
   * 
   * @return the chckPmtInfDtls
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps72100101ChckPmtInfDtls> getChckPmtInfDtls() {
        return chckPmtInfDtls;
    }	 
     
  /**
   * Sets the chckPmtInfDtls
   *
   * @param newChckPmtInfDtls the new chckPmtInfDtls
   */

    public void  setChckPmtInfDtls(java.util.Set<Beps72100101ChckPmtInfDtls> newChckPmtInfDtls) {
        chckPmtInfDtls = newChckPmtInfDtls;
    }	  
  /**
   * Returns the chckMsgDtls
   * 
   * @return the chckMsgDtls
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "parent")
    public java.util.Set<Beps72100101ChckMsgDtls> getChckMsgDtls() {
        return chckMsgDtls;
    }	 
     
  /**
   * Sets the chckMsgDtls
   *
   * @param newChckMsgDtls the new chckMsgDtls
   */

    public void  setChckMsgDtls(java.util.Set<Beps72100101ChckMsgDtls> newChckMsgDtls) {
        chckMsgDtls = newChckMsgDtls;
    }	  
