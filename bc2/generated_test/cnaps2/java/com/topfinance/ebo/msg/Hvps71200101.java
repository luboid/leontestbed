...
/**
 * Hvps71200101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_MSG_HVPS_712_001_01__")
public class Hvps71200101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="dtlReq.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="dtlReq.dtlReqInf.chckngDt")
    private Date chckngDt;
    
    @JaxbMapping(objPath="dtlReq.dtlReqInf.ttlCnt")
    private String ttlCnt;
    
    @JaxbMapping(objPath="dtlReq.dtlReqInf.dtls[0]")
    private java.util.Set<Hvps71200101Dtls> dtls;
   ...
   */
    ...
    public java.util.Set<Hvps71200101Dtls> getDtls() {
        return dtls;
    }	 
   ...
   */
    ...
    public void  setDtls(java.util.Set<Hvps71200101Dtls> newDtls) {
        dtls = newDtls;
    }	  
