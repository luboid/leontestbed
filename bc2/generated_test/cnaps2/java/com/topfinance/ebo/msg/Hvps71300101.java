...
/**
 * Hvps71300101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_MSG_HVPS_713_001_01__")
public class Hvps71300101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="dtlRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="dtlRspn.prttn.ttlNb")
    private String ttlNb;
    
    @JaxbMapping(objPath="dtlRspn.prttn.startNb")
    private String startNb;
    
    @JaxbMapping(objPath="dtlRspn.prttn.endNb")
    private String endNb;
    
    @JaxbMapping(objPath="dtlRspn.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="dtlRspn.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="dtlRspn.orgnlGrpHdr.orgnlMT")
    private String orgnlMT;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.chckDt")
    private Date chckngDt;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.prcSts")
    private String prcSts;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.prcCd")
    private String prcCd;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.rjctInf")
    private String rjctInf;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.netgDt")
    private Date netgDt;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.netgRnd")
    private String netgRnd;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.sttlmDt")
    private Date sttlmDt;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.rcvTm")
    private Date rcvTm;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.npcPrcInf.trnsmtTm")
    private Date trnsmtTm;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.ttlCnt")
    private String ttlCnt;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0]")
    private java.util.Set<Hvps71300101Dtls> dtls;
   ...
   */
    ...
    public java.util.Set<Hvps71300101Dtls> getDtls() {
        return dtls;
    }	 
   ...
   */
    ...
    public void  setDtls(java.util.Set<Hvps71300101Dtls> newDtls) {
        dtls = newDtls;
    }	  
