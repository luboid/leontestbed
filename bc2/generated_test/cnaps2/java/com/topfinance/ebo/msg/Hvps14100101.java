...
/**
 * Hvps14100101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_MSG_HVPS_141_001_01__")
public class Hvps14100101  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="finInstnCdtTrf.grpHdr.instgAgt.finInstnId.clrSysMmbId.mmbId")
    private String speMmbId;
    
    @JaxbMapping(objPath="finInstnCdtTrf.grpHdr.instdAgt.finInstnId.clrSysMmbId.mmbId")
    private String cNAPS2MmbId;
    ...
    @JaxbMapping(objPath="finInstnCdtTrf.cdtTrfTxInf.ultmtCdtr.finInstnId.clrSysMmbId.mmbId")
    private String mmbId;
    
    @JaxbMapping(objPath="finInstnCdtTrf.cdtTrfTxInf.rmtInf[0]")
    private java.util.Set<Hvps14100101RmtInf> rmtInf;
  ...
  /**
   * Returns the speMmbId
   * 
   * @return the speMmbId
   */
    @Column(name = "SPEMMBID")
    public String getSpeMmbId() {
        return speMmbId;
    }	 
   ...
   * Sets the speMmbId
   *
   * @param newSpeMmbId the new speMmbId
   */

    public void  setSpeMmbId(String newSpeMmbId) {
        speMmbId = newSpeMmbId;
    }	  
  /**
   * Returns the cNAPS2MmbId
   * 
   * @return the cNAPS2MmbId
   */
    @Column(name = "CNAPS2MMBID")
    public String getCNAPS2MmbId() {
        return cNAPS2MmbId;
    }	 
     
  /**
   * Sets the cNAPS2MmbId
   *
   * @param newCNAPS2MmbId the new cNAPS2MmbId
   */

    public void  setCNAPS2MmbId(String newCNAPS2MmbId) {
        cNAPS2MmbId = newCNAPS2MmbId;
    }	  
  /**
   ...
   */
    ...
    public void  setRmtInf(java.util.Set<Hvps14100101RmtInf> newRmtInf) {
        rmtInf = newRmtInf;
    }	  
