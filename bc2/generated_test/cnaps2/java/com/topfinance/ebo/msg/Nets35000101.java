...
/**
 * Nets35000101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_NETS_350")
public class Nets35000101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="getLmt.msgId.id")
    private String msgId;
    
    @JaxbMapping(objPath="getLmt.lmtQryDef.lmtCrit.newCrit.schCrit.acctId.dmstAcct.id")
