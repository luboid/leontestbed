...
/**
 * Beps12500101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_MSG_BEPS_125_001_01__")
public class Beps12500101  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="fiToFiCstmrCdtTrf.grpHdr.pmtTpInf.ctgyPurp.prtry")
    private String prtry;
    
    @JaxbMapping(objPath="fiToFiCstmrCdtTrf.cdtTrfTxInf[0]")
    private java.util.Set<Beps12500101CdtTrfTxInf> cdtTrfTxInf;
   ...
   */
    ...
    public java.util.Set<Beps12500101CdtTrfTxInf> getCdtTrfTxInf() {
        return cdtTrfTxInf;
    }	 
   ...
   */
    ...
    public void  setCdtTrfTxInf(java.util.Set<Beps12500101CdtTrfTxInf> newCdtTrfTxInf) {
