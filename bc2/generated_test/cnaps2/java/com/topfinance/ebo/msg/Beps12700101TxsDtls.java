...
@Entity
@Table(name = "T_MSG_BEPS_127_001_01___TxsDtls")
public class Beps12700101TxsDtls  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="cstmrDrctDbt.cstmrDrctDbtInf[0].cstmrDrctDbtAddtlInf.ntlTrsrInf.txsDtls[0].cptlAmt.value")
    ...
    @JaxbMapping(objPath="cstmrDrctDbt.cstmrDrctDbtInf[0].cstmrDrctDbtAddtlInf.ntlTrsrInf.txsDtls[0].acrlAmt.value")
    private Double ntlAcrlAmt;
    
    
	
    /** default constructor */
    public Beps12700101TxsDtls() {
    }
