 ...
 *       &lt;sequence>
 *         &lt;element name="DtAndPlcOfBirth" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.02}DateAndPlaceOfBirth" minOccurs="0"/>
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.02}GenericPersonIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PersonIdentification5 {
    ...
    protected List<GenericPersonIdentification1> othr = new Vector<GenericPersonIdentification1>();
    ...
    public List<GenericPersonIdentification1> getOthr() {
        if (othr == null) {
            othr = new Vector<GenericPersonIdentification1>();
        }
        return this.othr;
    }
