 ...
 *       &lt;sequence>
 *         &lt;element name="BICOrBEI" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.02}AnyBICIdentifier" minOccurs="0"/>
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.02}GenericOrganisationIdentification1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OrganisationIdentification4 {
    ...
    public List<GenericOrganisationIdentification1> getOthr() {
        if (othr == null) {
            othr = new Vector<GenericOrganisationIdentification1>();
        }
        return this.othr;
    }
