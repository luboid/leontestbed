...
public class PaymentTransactionInformation30 {
    ...
    protected Date orgnlReqdExctnDt;
    @XmlElement(name = "OrgnlReqdColltnDt", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    protected Date orgnlReqdColltnDt;
     ...
     *     
     */
    public Date getOrgnlReqdExctnDt() {
     ...
     *     
     */
    public void setOrgnlReqdExctnDt(Date value) {
     ...
     *     
     */
    public Date getOrgnlReqdColltnDt() {
     ...
     *     
     */
    public void setOrgnlReqdColltnDt(Date value) {
