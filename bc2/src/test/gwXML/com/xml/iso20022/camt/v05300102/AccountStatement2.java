...
public class AccountStatement2 {
    ...
    protected List<ReportEntry2> ntry = new Vector<ReportEntry2>();
	...
	public void setIntrst(List<AccountInterest2> intrst) {
		this.intrst = intrst;
	}

	public void setNtry(List<ReportEntry2> ntry) {
		this.ntry = ntry;
	}
