...
public class AmountAndCurrencyExchange3 {
    ...
    protected List<AmountAndCurrencyExchangeDetails4> prtryAmt = new Vector<AmountAndCurrencyExchangeDetails4>();
    ...
    public List<AmountAndCurrencyExchangeDetails4> getPrtryAmt() {
        if (prtryAmt == null) {
            prtryAmt = new Vector<AmountAndCurrencyExchangeDetails4>();
        }
