...
public class Dtls3 {
	...
	public void setChckngDtlOfSndg(List<SndgAndRcvg1> chckngDtlOfSndg) {
		this.chckngDtlOfSndg = chckngDtlOfSndg;
	}

	public void setChckngDtlOfRcvg(List<SndgAndRcvg1> chckngDtlOfRcvg) {
		this.chckngDtlOfRcvg = chckngDtlOfRcvg;
	}
