...
public class PaymentInstructionInformation3 {
    ...
    protected List<CreditTransferTransactionInformation10> cdtTrfTxInf = new Vector<CreditTransferTransactionInformation10>();
    ...
    public List<CreditTransferTransactionInformation10> getCdtTrfTxInf() {
        if (cdtTrfTxInf == null) {
            cdtTrfTxInf = new Vector<CreditTransferTransactionInformation10>();
        }
