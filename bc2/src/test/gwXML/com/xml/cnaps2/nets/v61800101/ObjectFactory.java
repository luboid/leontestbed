 ...
 * generated in the com.xml.cnaps2.nets.v61800101 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:nets:2010:tech:xsd:nets.618.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xml.cnaps2.nets.v61800101
     * 
     */
    ...
    /**
     * Create an instance of {@link BEPSNettingResponseInformation1 }
     * 
     */
    public BEPSNettingResponseInformation1 createBEPSNettingResponseInformation1() {
        return new BEPSNettingResponseInformation1();
    }

    /**
     * Create an instance of {@link BEPSNettingResponse }
     * 
     */
    public BEPSNettingResponse createBEPSNettingResponse() {
        return new BEPSNettingResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:nets:2010:tech:xsd:nets.618.001.01", name = "Document")
