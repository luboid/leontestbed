...
public class AccountCashEntrySearch2 {
    ...
    protected List<AccountIdentificationSearchCriteriaChoice> acctId = new Vector<AccountIdentificationSearchCriteriaChoice>();
    ...
    public List<AccountIdentificationSearchCriteriaChoice> getAcctId() {
        if (acctId == null) {
            acctId = new Vector<AccountIdentificationSearchCriteriaChoice>();
        }
        return this.acctId;
    }
