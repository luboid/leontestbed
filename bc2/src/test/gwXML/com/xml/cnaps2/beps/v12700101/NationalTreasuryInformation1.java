 ...
 *         &lt;element name="TxsDtls" type="{urn:cnaps:std:beps:2010:tech:xsd:beps.127.001.01}TransactionsDetails2" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class NationalTreasuryInformation1 {
    ...
    protected List<TransactionsDetails2> txsDtls = new Vector<TransactionsDetails2>();
     ...
     * {@link TransactionsDetails2 }
     * 
     * 
     */
    public List<TransactionsDetails2> getTxsDtls() {
        if (txsDtls == null) {
            txsDtls = new Vector<TransactionsDetails2>();
        }
        return this.txsDtls;
    }

	public void setTxsDtls(List<TransactionsDetails2> txsDtls) {
