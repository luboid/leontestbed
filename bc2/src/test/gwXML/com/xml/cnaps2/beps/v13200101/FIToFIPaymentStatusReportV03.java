...
public class FIToFIPaymentStatusReportV03 {
    ...
    protected List<PaymentTransactionInformation26> txInfAndSts = new Vector<PaymentTransactionInformation26>();
    ...
    public List<PaymentTransactionInformation26> getTxInfAndSts() {
        if (txInfAndSts == null) {
            txInfAndSts = new Vector<PaymentTransactionInformation26>();
        }
