...
public class BankToCustomerDebitCreditNotificationV02 {
    ...
    protected List<AccountNotification2> ntfctn = new Vector<AccountNotification2>();
    ...
    public List<AccountNotification2> getNtfctn() {
        if (ntfctn == null) {
            ntfctn = new Vector<AccountNotification2>();
        }
        return this.ntfctn;
    }

	public void setNtfctn(List<AccountNotification2> ntfctn) {
		this.ntfctn = ntfctn;
	}
