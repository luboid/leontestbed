...
/**
 * Nets37700101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_377")
public class Nets37700101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="lqdtyDbtTfr.msgId.id")
    private String msgId;
    
    @JaxbMapping(objPath="lqdtyDbtTfr.trfdAmt.amtWthCcy.value")
    private Double amtWthCcy;
    
    @JaxbMapping(objPath="lqdtyDbtTfr.dbtAcct.id.dmstAcct.id")
