...
/**
 * Beps40200101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_402")
public class Beps40200101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.qryBalOrStsTp")
    private String qryBalOrStsTp;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.acctId")
    private String acctId;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.rspsnInf.sts")
    private String sts;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.rspsnInf.rjctCd")
    private String rjctCd;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.rspsnInf.rjctInf")
    private String rjctInf;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.rspsnInf.prcPty")
    private String prcPty;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.bal.value")
    private Double bal;
    
    @JaxbMapping(objPath="realTmCstmrsAcctQryRspn.realTmCstmrsAcctQryRspnInf.acctSts")
   ...
   * Sets the accSts
   *
   * @param newAccSts the new accSts
   */

    public void  setAccSts(String newAccSts) {
        accSts = newAccSts;
    }	  
