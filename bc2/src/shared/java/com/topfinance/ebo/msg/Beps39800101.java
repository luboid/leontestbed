...
/**
 * Beps39800101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_398")
public class Beps39800101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.msgId")
    ...
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.chckCdtForLdRspnInf.rspsnInf.sts")
    private String sts;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.chckCdtForLdRspnInf.rspsnInf.rjctCd")
    private String rjctCd;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.chckCdtForLdRspnInf.rspsnInf.rjctInf")
    private String rjctInf;
    
    @JaxbMapping(objPath="chckCdtForLdRspn.chckCdtForLdRspnInf.rspsnInf.prcPty")
