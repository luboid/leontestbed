...
/**
 * Hvps71000101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_HVPS_710")
public class Hvps71000101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="acctChckngReq.grpHdr.msgId")
    ...
    @JaxbMapping(objPath="acctChckngReq.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="acctChckngReq.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="acctChckngReq.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="acctChckngReq.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="acctChckngReq.grpHdr.rmk")
    private String rmk;
