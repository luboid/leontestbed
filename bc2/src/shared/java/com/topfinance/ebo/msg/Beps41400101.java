...
/**
 * Beps41400101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_414")
public class Beps41400101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.prcSts")
    private String prcSts;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.prcCd")
    private String prcCd;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.rjctInf")
    private String rjctInf;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.netgDt")
    private Date netgDt;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.netgRnd")
    private String netgRnd;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.sttlmDt")
    private Date sttlmDt;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.rcvTm")
    private Date rcvTm;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.npcPrcInf.trnsmtTm")
    private Date trnsmtTm;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.orgnlTx.orgnlGrpHdr.orgnlMsgId")
    private String rspnInfOrgnlMsgId;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.orgnlTx.orgnlGrpHdr.orgnlMsgId")
    private String rspnInfOrgnlInstgDrctPty;
    
    @JaxbMapping(objPath="realTmBizRvslRspn.realTmBizRvslRspnInf.orgnlTx.orgnlGrpHdr.orgnlMsgTp")
    private String rspnInfOrgnlMT;
  ...
  /**
   * Returns the rspnInfOrgnlMsgId
   * 
   * @return the rspnInfOrgnlMsgId
   */
    @Column(name = "RSPNINFORGNLMSGID")
    public String getRspnInfOrgnlMsgId() {
        return rspnInfOrgnlMsgId;
    }	 
     
  /**
   * Sets the rspnInfOrgnlMsgId
   *
   * @param newRspnInfOrgnlMsgId the new rspnInfOrgnlMsgId
   */

    public void  setRspnInfOrgnlMsgId(String newRspnInfOrgnlMsgId) {
        rspnInfOrgnlMsgId = newRspnInfOrgnlMsgId;
    }	  
  /**
   * Returns the rspnInfOrgnlInstgDrctPty
   * 
   * @return the rspnInfOrgnlInstgDrctPty
   */
    @Column(name = "RSPNINFORGNLINSTGDRCTPTY")
    public String getRspnInfOrgnlInstgDrctPty() {
        return rspnInfOrgnlInstgDrctPty;
    }	 
     
  /**
   * Sets the rspnInfOrgnlInstgDrctPty
   *
   * @param newRspnInfOrgnlInstgDrctPty the new rspnInfOrgnlInstgDrctPty
   */

    public void  setRspnInfOrgnlInstgDrctPty(String newRspnInfOrgnlInstgDrctPty) {
        rspnInfOrgnlInstgDrctPty = newRspnInfOrgnlInstgDrctPty;
    }	  
  /**
   * Returns the rspnInfOrgnlMT
   * 
   * @return the rspnInfOrgnlMT
   */
    @Column(name = "RSPNINFORGNLMT")
    public String getRspnInfOrgnlMT() {
        return rspnInfOrgnlMT;
    }	 
     
  /**
   * Sets the rspnInfOrgnlMT
   *
   * @param newRspnInfOrgnlMT the new rspnInfOrgnlMT
   */

    public void  setRspnInfOrgnlMT(String newRspnInfOrgnlMT) {
        rspnInfOrgnlMT = newRspnInfOrgnlMT;
    }	  
