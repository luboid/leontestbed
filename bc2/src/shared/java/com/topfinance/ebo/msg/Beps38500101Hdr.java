...
/**
 * Beps38500101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_385_HDR")
public class Beps38500101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.btchCstmrsCtrctMgRspnInf.qryOrOprTp")
    private String qryOrOprTp;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.btchCstmrsCtrctMgRspnInf.acctCnt")
    private String acctCnt;
    
    @JaxbMapping(objPath="btchCstmrsCtrctMgRspn.btchCstmrsCtrctMgRspnInf.acctDtls[0]")
    private java.util.Set<Beps38500101> acctDtls;
    
    
	
    /** default constructor */
    public Beps38500101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Beps38500101> getAcctDtls() {
        return acctDtls;
    }	 
   ...
   */
    ...
    public void  setAcctDtls(java.util.Set<Beps38500101> newAcctDtls) {
