...
/**
 * Saps60900101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_609")
public class Saps60900101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.intraCityNetgQryApplInf.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.intraCityNetgQryApplInf.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="intraCityNetgQryAppl.intraCityNetgQryApplInf.orgnlGrpHdr.orgnlMT")
