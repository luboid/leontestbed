...
/**
 * Nets37600101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_376")
public class Nets37600101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="lqdtyCdtTfr.msgId.id")
    private String msgId;
    
    @JaxbMapping(objPath="lqdtyCdtTfr.cdtAcct.id.dmstAcct.id")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="lqdtyCdtTfr.trfdAmt.amtWthCcy.value")
