...
/**
 * Ccms31500101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_315")
public class Ccms31500101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.creDtTm")
    private String creDtTm;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="bizRspn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="bizRspn.orgnlGrpHdr.orgnlMsgId")
    private String qrOrgnlMsgId;
    
    @JaxbMapping(objPath="bizRspn.orgnlGrpHdr.orgnlInstgPty")
    private String qrOrgnlInstgDrctPty;
    
    @JaxbMapping(objPath="bizRspn.orgnlGrpHdr.orgnlMsgTp")
    private String qrOrgnlMT;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.qryTp")
    private String qryTp;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlGrpHdr.orgnlMsgTp")
    private String orgnlMT;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlTx.instgIndrctPty")
    private String orgnlInstgIndrctPty;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlTx.instdIndrctPty")
    private String orgnlInstdIndrctPty;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlTx.orgnlTxId")
    private String orgnlTxId;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlTx.orgnlTxTpCd")
    private String orgnlTxTpCd;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.orgnlInf.orgnlAmt")
    private Double orgnlAmt;
    
    @JaxbMapping(objPath="bizRspn.bizRspnInf.cntt")
    private String cntt;
  ...
  /**
   * Returns the qrOrgnlMsgId
   * 
   * @return the qrOrgnlMsgId
   */
    @Column(name = "QRORGNLMSGID")
    public String getQrOrgnlMsgId() {
        return qrOrgnlMsgId;
    }	 
     
  /**
   * Sets the qrOrgnlMsgId
   *
   * @param newQrOrgnlMsgId the new qrOrgnlMsgId
   */

    public void  setQrOrgnlMsgId(String newQrOrgnlMsgId) {
        qrOrgnlMsgId = newQrOrgnlMsgId;
    }	  
  /**
   * Returns the qrOrgnlInstgDrctPty
   * 
   * @return the qrOrgnlInstgDrctPty
   */
    @Column(name = "QRORGNLINSTGDRCTPTY")
    public String getQrOrgnlInstgDrctPty() {
        return qrOrgnlInstgDrctPty;
    }	 
     
  /**
   * Sets the qrOrgnlInstgDrctPty
   *
   * @param newQrOrgnlInstgDrctPty the new qrOrgnlInstgDrctPty
   */

    public void  setQrOrgnlInstgDrctPty(String newQrOrgnlInstgDrctPty) {
        qrOrgnlInstgDrctPty = newQrOrgnlInstgDrctPty;
    }	  
  /**
   * Returns the qrOrgnlMT
   * 
   * @return the qrOrgnlMT
   */
    @Column(name = "QRORGNLMT")
    public String getQrOrgnlMT() {
        return qrOrgnlMT;
    }	 
   ...
   * Sets the qrOrgnlMT
   *
   * @param newQrOrgnlMT the new qrOrgnlMT
   */

    public void  setQrOrgnlMT(String newQrOrgnlMT) {
        qrOrgnlMT = newQrOrgnlMT;
    }	  
  /**
   * Returns the qryTp
   * 
  ...
  /**
   * Returns the orgnlAmt
   * 
   * @return the orgnlAmt
   */
    @Column(name = "ORGNLAMT")
    public Double getOrgnlAmt() {
        return orgnlAmt;
    }	 
   ...
   * Sets the orgnlAmt
   *
   * @param newOrgnlAmt the new orgnlAmt
   */

    public void  setOrgnlAmt(Double newOrgnlAmt) {
        orgnlAmt = newOrgnlAmt;
    }	  
  /**
   * Returns the cntt
   * 
