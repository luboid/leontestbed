...
/**
 * Ccms91600101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_916_HDR")
public class Ccms91600101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.prttn.ttlNb")
    private String ttlNb;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.prttn.startNb")
    private String startNb;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.prttn.endNb")
    private String endNb;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.nbInf.chngNb")
    private String chngNb;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.nbInf.chngRcrdNb")
    private String chngRcrdNb;
    
    @JaxbMapping(objPath="bkCdChngNtfctn.chngInf[0]")
    private java.util.Set<Ccms91600101> chngInf;
    
    
	
    /** default constructor */
    public Ccms91600101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Ccms91600101> getChngInf() {
        return chngInf;
    }	 
   ...
   * Sets the chngInf
   *
   * @param newChngInf the new chngInf
   */

    public void  setChngInf(java.util.Set<Ccms91600101> newChngInf) {
        chngInf = newChngInf;
    }	  
