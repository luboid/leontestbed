...
/**
 * Hvps71400101TxsDtls generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_HVPS_714_EXT")
public class Hvps71400101TxsDtls  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="txDwnldgReq.txDwnldgReqInf.txsDtls[0].sndRcvTp")
    private String sndRcvTp;
    
    @JaxbMapping(objPath="txDwnldgReq.txDwnldgReqInf.txsDtls[0].orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="txDwnldgReq.txDwnldgReqInf.txsDtls[0].orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="txDwnldgReq.txDwnldgReqInf.txsDtls[0].orgnlGrpHdr.orgnlMT")
    private String orgnlMT;
    
    private Hvps71400101 fid;
    
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="FID", nullable=false, updatable=false)
    public Hvps71400101 getFid() {
		return fid;
	}


	public void setFid(Hvps71400101 fid) {
		this.fid = fid;
	}


	/** default constructor */
    public Hvps71400101TxsDtls() {
    }
