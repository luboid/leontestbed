...
/**
 * Ccms90600101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_906_HDR")
public class Ccms90600101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.creDtTm")
    private String creDtTm;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="bizClssTpMgmt.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="bizClssTpMgmt.chngInf[0]")
    private java.util.Set<Ccms90600101> chngInf;
    
    
	
    /** default constructor */
    public Ccms90600101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Ccms90600101> getChngInf() {
        return chngInf;
    }	 
   ...
   */
    ...
    public void  setChngInf(java.util.Set<Ccms90600101> newChngInf) {
        chngInf = newChngInf;
    }	  
