...
/**
 * Saps73100101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_731_HDR")
public class Saps73100101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.acsabsSttlmDtlApplInf.chckngDt")
    private Date chckngDt;
    
    @JaxbMapping(objPath="acsabsSttlmDtlAppl.acsabsSttlmDtlApplInf.qryInf[0]")
    private java.util.Set<Saps73100101> qryInf;
    
    
	
    /** default constructor */
    public Saps73100101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Saps73100101> getQryInf() {
        return qryInf;
    }	 
   ...
   * Sets the qryInf
   *
   * @param newQryInf the new qryInf
   */

    public void  setQryInf(java.util.Set<Saps73100101> newQryInf) {
        qryInf = newQryInf;
    }	  
