...
/**
 * Nets40600101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_NETS_406")
public class Nets40600101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="netgQQryRspn.qInf.dtls[0].orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="netgQQryRspn.qInf.dtls[0].orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="netgQQryRspn.qInf.dtls[0].orgnlGrpHdr.orgnlMT")
    private String orgnlMT;
    
    @JaxbMapping(objPath="netgQQryRspn.qInf.dtls[0].amt.value")
    private Double amt;
    
    @JaxbMapping(objPath="netgQQryRspn.qInf.dtls[0].seqNb")
    private String seqNb;
    
    private Nets40600101Hdr fid;
	
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="FID", nullable=false, updatable=false)
    public Nets40600101Hdr getFid() {
		return fid;
	}


	public void setFid(Nets40600101Hdr fid) {
		this.fid = fid;
	}
