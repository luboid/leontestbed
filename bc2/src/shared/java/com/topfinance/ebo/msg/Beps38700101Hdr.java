...
/**
 * Beps38700101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_387_HDR")
public class Beps38700101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.btchCstmrsAcctQryInf.acctCnt")
    private String acctCnt;
    
    @JaxbMapping(objPath="btchCstmrsAcctQry.btchCstmrsAcctQryInf.acctDtls[0]")
    private java.util.Set<Beps38700101> acctDtls;
    
    
	
    /** default constructor */
    public Beps38700101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Beps38700101> getAcctDtls() {
        return acctDtls;
    }	 
   ...
   */
    ...
    public void  setAcctDtls(java.util.Set<Beps38700101> newAcctDtls) {
