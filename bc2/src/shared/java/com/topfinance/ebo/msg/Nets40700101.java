...
/**
 * Nets40700101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_NETS_407")
public class Nets40700101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="netgQMgmt.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="netgQMgmt.qMgmtApplInf.orgnlGrpHdr.orgnlMsgId")
    private String orgnlMsgId;
    
    @JaxbMapping(objPath="netgQMgmt.qMgmtApplInf.orgnlGrpHdr.orgnlInstgPty")
    private String orgnlInstgDrctPty;
    
    @JaxbMapping(objPath="netgQMgmt.qMgmtApplInf.orgnlGrpHdr.orgnlMT")
    private String orgnlMT;
    
    @JaxbMapping(objPath="netgQMgmt.qMgmtApplInf.qChngTp")
    private String qChngTp;
   ...
   * Sets the qChngTp
   *
   * @param newQChngTp the new qChngTp
   */

    public void  setQChngTp(String newQChngTp) {
        qChngTp = newQChngTp;
    }	  
