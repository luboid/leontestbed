...
/**
 * Ccms80700102 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_807")
public class Ccms80700102  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.creDtTm")
    private String creDtTm;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="logoutNtfctn.grpHdr.rmk")
    private String rmk;
