...
/**
 * Saps36800101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_368")
public class Saps36800101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="lqdtyQryAppl.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="lqdtyQryAppl.lqdtyQryApplInf.qryTp")
    private String qryTp;
    
    @JaxbMapping(objPath="lqdtyQryAppl.lqdtyQryApplInf.mgrId")
