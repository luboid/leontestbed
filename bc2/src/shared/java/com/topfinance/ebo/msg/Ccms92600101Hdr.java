...
/**
 * Ccms92600101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_926_HDR")
public class Ccms92600101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="txAmtUpperLmt.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="txAmtUpperLmt.txAmtUpperLmtInf[0]")
    private java.util.Set<Ccms92600101> txAmtUpperLmtInf;
    
    
	
    /** default constructor */
    public Ccms92600101Hdr() {
    }
  ...
  /**
   * Returns the txAmtUpperLmtInf
   * 
   * @return the txAmtUpperLmtInf
   */
  	@OneToMany(fetch = FetchType.EAGER, cascade=CascadeType.ALL, mappedBy = "fid")
    public java.util.Set<Ccms92600101> getTxAmtUpperLmtInf() {
        return txAmtUpperLmtInf;
    }	 
     
  /**
   * Sets the txAmtUpperLmtInf
   *
   * @param newTxAmtUpperLmtInf the new txAmtUpperLmtInf
   */

    public void  setTxAmtUpperLmtInf(java.util.Set<Ccms92600101> newTxAmtUpperLmtInf) {
        txAmtUpperLmtInf = newTxAmtUpperLmtInf;
    }	  
