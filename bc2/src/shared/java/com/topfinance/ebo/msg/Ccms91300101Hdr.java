...
/**
 * Ccms91300101Hdr generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_CCMS_913_HDR")
public class Ccms91300101Hdr  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.creDtTm")
    private String creDtTm;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.prttn.ttlNb")
    private String ttlNb;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.prttn.startNb")
    private String startNb;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.prttn.startNb")
    private String endNb;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.nbInf.chngNb")
    private String chngNb;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.nbInf.chngRcrdNb")
    private String chngRcrdNb;
    
    @JaxbMapping(objPath="cisAgcyChngNtfctn.chngInf[0]")
    private java.util.Set<Ccms91300101> chngInf;
    
    
	
    /** default constructor */
    public Ccms91300101Hdr() {
    }
   ...
   */
    ...
    public java.util.Set<Ccms91300101> getChngInf() {
        return chngInf;
    }	 
   ...
   */
    ...
    public void  setChngInf(java.util.Set<Ccms91300101> newChngInf) {
        chngInf = newChngInf;
    }	  
