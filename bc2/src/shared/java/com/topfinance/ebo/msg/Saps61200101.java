...
/**
 * Saps61200101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_612")
public class Saps61200101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.msgId")
    private String creDtTm;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="unltrlTx.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="unltrlTx.unltrlTxInf.bookgId")
    private String bookgId;
    
    @JaxbMapping(objPath="unltrlTx.unltrlTxInf.dbtCdtId")
    private String dbtCdtId;
    
    @JaxbMapping(objPath="unltrlTx.unltrlTxInf.amt")
    private Double amt;
    
    @JaxbMapping(objPath="unltrlTx.unltrlTxInf.txTp")
    private String txTp;
    
    @JaxbMapping(objPath="unltrlTx.unltrlTxInf.ctgyPurpCd")
