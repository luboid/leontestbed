...
public class Ccms80900102Hdr  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="stopgNtfctn.ndInf.ptyId")
    private java.util.Set<Ccms80900102> fakeNode;
   ...
   * Sets the newSts
   *
   * @param newNewSts the new newSts
   */
   ...
   *
   * @param newEstmtdStartSvc the new estmtdStartSvc
   */
   ...
   */
    ...
    public java.util.Set<Ccms80900102> getFakeNode() {
        return fakeNode;
    }	 
   ...
   */
    ...
    public void  setFakeNode(java.util.Set<Ccms80900102> newFakeNode) {
