...
@Entity
@Table(name = "T_C2_HVPS_713_EXT_GEINFO")
public class Hvps71300101Dtls  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgCtrlSum")
    private Double sndgCtrlSum;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].rcvgNbOfTxs")
    private String rcvgNbOfTxs;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].rcvgCtrlSum")
    ...
    private Hvps71300101 fid;
    
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="FID", nullable=false, updatable=false)
    public Hvps71300101 getFid() {
		return fid;
	}


	public void setFid(Hvps71300101 fid) {
		this.fid = fid;
	}
