...
public class Hvps71300101SndgChckngDtl  implements java.io.Serializable {
    ...
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgChckngDtl[0].orgnlGrpHdr.orgnlMsgId")
    private String bizSenOrgnlMsgId;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgChckngDtl[0].orgnlGrpHdr.orgnlInstgPty")
    private String bizSenOrgnlInstgDrctPty;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgChckngDtl[0].orgnlGrpHdr.orgnlMT")
    private String bizSenOrgnlMT;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgChckngDtl[0].amt")
    private Double bizSenAmt;
    
    @JaxbMapping(objPath="dtlRspn.dtlRspnInf.dtls[0].sndgChckngDtl[0].prcSts")
