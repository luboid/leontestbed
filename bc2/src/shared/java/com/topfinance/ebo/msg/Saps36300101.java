...
/**
 * Saps36300101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_SAPS_363")
public class Saps36300101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="qQryAppl.grpHdr.rmk")
    private String rmk;
    
    @JaxbMapping(objPath="qQryAppl.qQryApplInf.qryTp")
    private String qryTp;
    
    @JaxbMapping(objPath="qQryAppl.qQryApplInf.mgrId")
