...
/**
 * Beps72000101 generated by ParseSampleXml
 */
 
@Entity
@Table(name = "T_C2_BEPS_720")
public class Beps72000101  implements java.io.Serializable {

    // Fields 
    @JaxbMapping(objPath="")
    private Integer id;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.msgId")
    private String msgId;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.creDtTm")
    private Date creDtTm;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.instgPty.instgDrctPty")
    private String instgDrctPty;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.instgPty.instgPty")
    private String instgIndrctPty;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.instdPty.instdDrctPty")
    private String instdDrctPty;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.instdPty.instdPty")
    private String instdIndrctPty;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.sysCd")
    private String sysCd;
    
    @JaxbMapping(objPath="ttlChckInfReq.grpHdr.sysCd")
    private String rmk;
    
    @JaxbMapping(objPath="ttlChckInfReq.ttlChckInfReqInf.chckDt")
