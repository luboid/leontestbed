...
public String toString() {
	return "Ibps10100101 [uuid=" + uuid + ", grpHdrMsgId=" + grpHdrMsgId
			+ ", creDtTm=" + creDtTm + ", btchBookg=" + btchBookg
			+ ", nbOfTxs=" + nbOfTxs + ", ctrlSum=" + ctrlSum
			+ ", intrBkSttlmDt=" + intrBkSttlmDt + ", sttlmMtd=" + sttlmMtd
			+ ", endToEndId=" + endToEndId + ", pmtIdTxId=" + pmtIdTxId
			+ ", instrPrty=" + instrPrty + ", ctgyPurpPrtry=" + ctgyPurpPrtry
			+ ", intrBkSttlmAmtValue=" + intrBkSttlmAmtValue
			+ ", intrBkSttlmAmtCcy=" + intrBkSttlmAmtCcy + ", accptncDtTm="
			+ accptncDtTm + ", chrgBr=" + chrgBr + ", dbtrNm=" + dbtrNm
			+ ", emailAdr=" + emailAdr + ", dbtrAcctIdOthrId="
			+ dbtrAcctIdOthrId + ", dbtrAcctIdOthrIssr=" + dbtrAcctIdOthrIssr
			+ ", tpPrtry=" + tpPrtry + ", clrSysMmbIdMmbId=" + clrSysMmbIdMmbId
			+ ", brnchIdId=" + brnchIdId + ", ctrySubDvsn=" + ctrySubDvsn
			+ ", clrSysMmbIdMmbId1=" + clrSysMmbIdMmbId1 + ", brnchIdId1="
			+ brnchIdId1 + ", cdtrNm=" + cdtrNm + ", cdtrAcctIdOthrId="
			+ cdtrAcctIdOthrId + ", purpPrtry=" + purpPrtry + ", rmtInfUstrd="
			+ rmtInfUstrd + ", ts=" + ts + "]";
}	  
