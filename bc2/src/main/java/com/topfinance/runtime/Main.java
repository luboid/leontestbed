...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<ICfgTransIn> listTransIn = reader.getListOfTransIn();
            for(ICfgTransIn ti : listTransIn) {
                BCUtils.initCamelComponentIn(camel, ti);
            }
            
            List<ICfgTransOut> listTransOut = reader.getListOfTransOut();
            for(ICfgTransOut ti : listTransOut) {
