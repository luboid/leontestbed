...
//                length=30)
@DiscriminatorValue("")
public class JpaCfgPortIn implements ICfgPortIn {
    ...
    private JpaCfgTransIn transIn;
    
    private JpaCfgNode node;
    
    private JpaCfgProtocol protocol;
    
    private JpaCfgPortOut ackPort;
    ...
    public JpaCfgTransIn getTransIn() {
        return transIn;
    }

    public void setTransIn(JpaCfgTransIn transIn) {
    ...
    public JpaCfgPortOut getAckPort() {
        return ackPort;
    }

    public void setAckPort(JpaCfgPortOut ackPort) {
