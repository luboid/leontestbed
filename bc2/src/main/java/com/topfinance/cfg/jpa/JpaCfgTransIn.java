...
public class JpaCfgTransIn implements ICfgTransIn {
    ...
    @SequenceGenerator(name = "CFG_TI_IN_GEN", sequenceName = "S_CFG_SEQUNCE")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "CFG_TI_IN_GEN")
